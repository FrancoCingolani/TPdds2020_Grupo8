...
public class Main {
	...
	public static void main(String[] args) throws FileNotFoundException, IOException{
		...
		Criterio criterioUbicacion = new Criterio ("ubicaci贸n");
    	    	 ...
    	    	 System.out.println("Escribe una de las opciones:");
    		      ...
    		      switch (opcion) {
    		      	...
    		      	case 3:
    	                ...
    	                break;
    		      	case 4:
    		     //una vez que sepamos como hacer lo de los items, modificar esto
...
public static Organizacion crearOrganizacion() {
	System.out.println("Elige el tipo de Organizaci贸n: ");
...
public static Actividad elegirActividad() {
    ...
    System.out.println("1. Construcci贸n");
...
public static Compra crearCompra() {
    ...
    if(cantPresu>0) {
    	...
    	System.out.println("縀s el presupuesto que se ha elegido al final?  (Y/N)");//Muy groncho, pero efectivo
