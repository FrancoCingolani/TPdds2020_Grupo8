...
public class Bitacora {
	...
	public static void insertarEnBitacora(String user, String accion, Map<String, String> datosObjeto) {
		...
		//  Directamente me llegan los datos del objeto que quiero guardar, así que voy a crear un nuevo documento e iterar sobre el Map para obtener todos los valores
		datosObjeto.forEach((key, value) -> registro.append(key, value));
		
		// Agrego el tipo de acción realizada y el usuario que las hizo
