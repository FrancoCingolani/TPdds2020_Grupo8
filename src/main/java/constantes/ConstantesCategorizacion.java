...
public class ConstantesCategorizacion {
	...
	public static final long VENTAS_CONSTRUCCION_PEQUENIA  = 90310000;
	...
	public static final int PERSONAL_CONSTRUCCION_PEQUENIA  = 45;
	...
	public static final long VENTAS_SERVICIOS_PEQUENIA  = 85950000;
	...
	public static final int PERSONAL_SERVICIOS_PEQUENIA  = 30;
	...
	public static final long VENTAS_COMERCIO_PEQUENIA  = 178860000;
	...
	public static final int PERSONAL_COMERCIO_PEQUENIA  = 35;
	...
	public static final long VENTAS_INDUSTRIAMINERIA_PEQUENIA  = 190410000;
	...
	public static final int PERSONAL_INDUSTRIAMINERIA_PEQUENIA  = 60;
	...
	public static final long VENTAS_AGROPECUARIO_PEQUENIA  = 48480000;
	...
	public static final int PERSONAL_AGROPECUARIO_PEQUENIA  = 10;
	...
	public static final Map<Integer, Long> VENTAS_CONSTRUCCION = ImmutableMap.of(
		...
		ConstantesCategorias.PEQUENIA, VENTAS_CONSTRUCCION_PEQUENIA,
	...
	public static final Map<Integer, Integer> PERSONAL_CONSTRUCCION = ImmutableMap.of(
		...
		ConstantesCategorias.PEQUENIA, PERSONAL_CONSTRUCCION_PEQUENIA,
	...
	public static final Map<Integer, Long> VENTAS_SERVICIO = ImmutableMap.of(
		...
		ConstantesCategorias.PEQUENIA, VENTAS_SERVICIOS_PEQUENIA,
	...
	public static final Map<Integer, Integer> PERSONAL_SERVICIO = ImmutableMap.of(
		...
		ConstantesCategorias.PEQUENIA, PERSONAL_SERVICIOS_PEQUENIA,
	...
	public static final Map<Integer, Long> VENTAS_COMERCIO = ImmutableMap.of(
		...
		ConstantesCategorias.PEQUENIA, VENTAS_COMERCIO_PEQUENIA,
	...
	public static final Map<Integer, Integer> PERSONAL_COMERCIO = ImmutableMap.of(
		...
		ConstantesCategorias.PEQUENIA, PERSONAL_COMERCIO_PEQUENIA,
	...
	public static final Map<Integer, Long> VENTAS_INDUSTRIAMINERIA = ImmutableMap.of(
		...
		ConstantesCategorias.PEQUENIA, VENTAS_INDUSTRIAMINERIA_PEQUENIA,
	...
	public static final Map<Integer, Integer> PERSONAL_INDUSTRIAMINERIA = ImmutableMap.of(
		...
		ConstantesCategorias.PEQUENIA, PERSONAL_INDUSTRIAMINERIA_PEQUENIA,
	...
	public static final Map<Integer, Long> VENTAS_AGROPECUARIO = ImmutableMap.of(
		...
		ConstantesCategorias.PEQUENIA, VENTAS_AGROPECUARIO_PEQUENIA,
	...
	public static final Map<Integer, Integer> PERSONAL_AGROPECUARIO = ImmutableMap.of(
		...
		ConstantesCategorias.PEQUENIA, PERSONAL_AGROPECUARIO_PEQUENIA,
